...
import os
import json
from .db import fetch_and_upload
...
my_updated_assistant = client.beta.assistants.update(
  ...
  instructions="You will perform operation on data that consists of header: DATE, TRANSACTION_DETAILS, CATEGORY, WITHDRAWAL_AMT, DEPOSIT_AMT.  You should avoid multiple code_interpreter session and try to execute everything in one go, given the column header and database information. Use forecast_visualisation instead of data_visualisation when it involves predicting future data. You should always show visualisation in the end. If data is insufficient for prediction due to small amount of data, just proceed with prediction and ignore low accuracy",
  ...
  tools=[{"type": "code_interpreter"},
         ...
         {"type": "function",
            "function":{
                ...
                "description": "Visualise forecastedd data into two-line-graph when necessary to observe the data trend.",
                "parameters": {
                    "type": "object",
                    "properties": {
                    "type": {
                    ...
                    "actual_data": {
                        ...
                        "x": {
                            "type": "array",
                            "description": "X-axis of the actual data representing the categories or intervals",
                            "items": {
                                "type": "string"
                            }
                        },
                        "y": {
                            "type": "array",
                            "description": "Y-axis of the actual data representing the values corresponding to each category or interval on the X-axis",
                            "items": {
                                "type": "number"
                            }
                        }
                    ...
                    "forecast_data": {
                        ...
                        "x": {
                            "type": "array",
                            "description": "X-axis for the forcasted data representing the categories or intervals",
                            "items": {
                                "type": "string"
                            }
                        },
...
def run_model(prompt):
    ...
    return {"message":"Success", "data_visualisation":data_visualisation_response, "forecast_visualisation":forecast_visualisation_response}
